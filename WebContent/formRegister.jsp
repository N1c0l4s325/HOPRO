...
<div class="container-second">
	...
	<form class="form-register" id="form-register" action="../src/com/controllers/servlets/Usuario.java"  method="get">
		...
		<div class="form-group" id="group-country">
			<label for="numberIde" class="form-label">Tipo identificacion</label>
			<div class="form_register-input">
			  <select name="typeIde" class="form-select" id="form-select">
				  <option value=""></option>
		...
		<div class="form-group" id="group-country">
			<label for="numberIde" class="form-label">N° Dni o Pasaporte</label>
			<div class="form_register-input">
