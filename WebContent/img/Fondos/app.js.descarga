    ...
    OQde: function(e, t) {
        $(document).ready(function() {
            ...
            $(window).scroll(function() {
                ...
                var e = e || 5;
                $("#count").html("Generando enlace de descarga " + e.toString()), setIntervalID = setInterval(function() {
                    e--, e >= 0 && $("#count").html("Generando enlace de descarga " + e.toString()), 0 === e && ($("#count").html(""), $("#download").removeClass("hide"), $("#download_menu").removeClass("hide"), $("#adsdimmer .details").removeClass("hide"), clearInterval(setIntervalID))
                }, 1e3)
